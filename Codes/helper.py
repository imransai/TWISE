...
class logger:
    ...
    def loss_summarize(self, mode, trainloss, valloss, duration, curr_step = 0):
        print('curr_step {:d},trainloss_tot = {:.7f}, valloss_tot = {:.7f}, ({:.7f} sec/step)'.format(curr_step,
                                            trainloss, valloss, duration))                   

    def loss_summarize_v2(self, mode, trainloss, trainlossmaince, valloss, vallossmaince, duration, curr_step = 0):
        print('curr_step {:d},trainloss_tot = {:.7f}, train_maince = {:.7f}, valloss_tot = {:.7f}, valmaince = {:.7f}, ({:.7f} sec/step)'.format(curr_step,
                                            trainloss, trainlossmaince, valloss, vallossmaince, duration))
    
    
    def loss_summarize_v3(self, mode, trainloss, trainlossmaince, trainlossfusion, valloss, vallossmaince, vallossfusion, duration, curr_step = 0):
        print('curr_step {:d},trainloss_tot = {:.7f}, train_maince = {:.7f}, train_fusion = {:7f}, valloss_tot = {:.7f}, valmaince = {:.7f}, valloss_fusion = {:7f}, ({:.7f} sec/step)'.format(curr_step,
